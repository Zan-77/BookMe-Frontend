    ...
    return (
        <div className='relative bg-inherit group/tooltip' {...props}>
            <span className={positions[position] + " "
                + "absolute z-10 max-md:hidden invisible group-hover/tooltip:visible rounded-xs max-w-96 w-1/2 p-2 text-light-text-muted dark:text-dark-text-dark/80 bg-light-light text-sm dark:bg-dark outline-1 lg:outline-2 outline-light dark:outline-dark-light"
            }>{tip}
            </span>
            {children}
        </div>
