...
const Register = () => {
  ...
  return (
    <form className="flex flex-col w-full h-dvh bg-light-dark dark:bg-dark-dark md:bg-light md:dark:bg-dark p-4 *:my-5 md:w-[28%] md:h-fit md:px-8 md:rounded-sm md:border-2 md:border-light-light md:dark:border-dark-light"
      ...
      <Tolltip tip="Password must be at least 8 characters long and contain at least 3 lower case, 2 upper case, 2 numbers and and 1 symbol" position="right">
